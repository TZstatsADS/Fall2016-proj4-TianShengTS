...
test_data_path <- ""
data_output_path <- "/Users/YaqingXie/Desktop"
...
save(pca_matrix, file = paste(data_output_path, "/pca_loading.rda", sep=""))
...
# pca_matrix <- load(paste(outputpath, "/pca_loading.rda", sep=""))
test_data_pca <- as.matrix(test_data2) %*% pca_matrix
test_data_pca <- rbind(test_data1, test_data_pca)
